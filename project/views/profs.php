...
<body>
      ...
      <div class="masthead">
        <h3 class="text-muted">Doctors</h3>
        <nav>
          <ul class="nav nav-justified">
            <li class=""><a href="<?php echo $this->base_url(''); ?>">Home</a></li>
            <li class=""><a href="<?php echo $this->base_url('department/departments'); ?>">Deparments</a></li>
            <li class="active"><a href="<?php echo $this->base_url('getProfs/profs'); ?>">Doctors</a></li>
...
<?php foreach ($profes as $prof): ?> 
	<li class="list-group-item">Prof. <?php echo $prof['name'];?></li>
<?php endforeach;?>
</ul>
      <!-- Site footer -->
      <footer class="footer">
