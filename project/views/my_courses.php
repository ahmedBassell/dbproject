...
<body>
      ...
      <div class="masthead">
        <h3 class="text-muted">My Courses</h3>
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="<?php echo $this->base_url('course/my_courses'); ?>">My Courses</a></li>
...
<?php if(count($my_courses) > 0): ?>
	...
	<?php endforeach;?>
<?php else: ?>
	<li class="list-group-item">You Have No Courses</li>
<?php endif; ?>
</ul>
      <!-- Site footer -->
      <footer class="footer">
